...
class CandidatesControllerTest < ActionController::TestCase
  ...
  test "should create candidate" do
    assert_difference('Candidate.count') do
      post :create, candidate: { name: @candidate.name, votes_count: @candidate.votes_count }
    end
  ...
  test "should update candidate" do
    patch :update, id: @candidate, candidate: { name: @candidate.name, votes_count: @candidate.votes_count }
    assert_redirected_to candidate_path(assigns(:candidate))
  end
